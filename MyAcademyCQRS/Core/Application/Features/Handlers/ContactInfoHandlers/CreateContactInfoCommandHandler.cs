...
{
    public class CreateContactInfoCommandHandler(IRepository<ContactInfo> repository, IUnitOfWork unitOfWork, IMapper mapper, IValidator<CreateContactInfoCommand> validator) : IRequestHandler<CreateContactInfoCommand, Result>
    {
